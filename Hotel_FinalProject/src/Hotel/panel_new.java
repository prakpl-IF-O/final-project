//Package Hotel adalah package dari class/form panel_new
package Hotel;
...
//@author ltf
//Deklarasi class atau form panel new, yang berfungsi untuk membuat member baru, class ini merupakan gui jframe maka menjadi turunan swing jframe
...
//initComponent merupakan method yg saat membuat jframe tergenerate otomatis, karena fungsinya sebagai instalator komponen gui dan menghubungkan ke class
    ...
    //Deklarasi comboBox pilihan kamar
    ...
    //Deklarasi tempat text / textfield untuk nama
    ...
    //Deklarasi tempat text / textfield untuk tempat lahir
    ...
    /*
    Deklarasi variable int cek dengan nilai 0
    Deklarasi variable objek pelanggan p yang menginstansiasi objek    */
    int cek = 0;
    Pelanggan p = new Pelanggan();

    /*
    Deklarasi method button submit untuk melakukan aksi submit 
    Deklarasi object select dengan nilai ambilan dari variable combo box pilih kamar
    Deklarasi variable String nama,tempatlahir,tanggallahir dan nik
    Deklarasi variable int noKamar dan hari
    Deklarasi Transaksi t
    Deklarasi Kamar k
    Coba
    Jika cek = 0 maka nik,nama,tanggal lahir dan tempat lahir mengambil text yg diinput 
    Coba
    Variable p = instansiasi objek pelanggan dengan parameter nik,nama,tempat dan tanggal lahir
    Assign variable cek dengan nilai = 1
    Deklarasi String data dengan isi perintah ke database bahwa tampilkan pelanggan terdaftar dan melakukan pilih kelas dan nomor kamar dan lama bermalm kemudian klik submit
    Tampilkan pesan dialog data
    Kemudian melakukan edit lama menginap dan nomor kamar
    Jika coba gagal tampilkan pesan error
    Cek terganti menjadi 1 maka else dari 0 dan melakukan pemilihan kamar sama dengan panel member
    */
    ...
    //Deklarasi method button cancel dan tidak ditampilkan
