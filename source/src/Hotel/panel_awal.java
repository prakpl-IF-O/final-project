...
/*@author ltf
Deklarasi class panel_awal turunan dari Jframe, karena ini adalah class gui jadi dia menurunkan beberapa fungsi gui
Deklarasi objek pk
Fungsi panel ini adalah menu memilih check in (cek kamar, bikin member baru, memesan kamar member yg telah terdaftar) atau check out (melihat data check out atau transaksi) */
...
//Deklarasi constructor panel_awal
...
//Deklarasi method button, deklarasi panel pn dan menampilkannya (true)
...
//Deklarasi method button c out, deklarasi panel pco dan menampilkannya (true)
...
//Deklarasi method button cek kamar, try instansiasi panel kamar dari variable pk catch jika terjadi error, jika tidak pk set ukuran dan ditampilkan
...
//Deklarasi method button member, membuat panel member pn dan menampilkannya     
...
//Deklarasi method button transaksi, membuat panel tabel transaksi ptt dan menampilkannya
    ...
    /**
     * @param args the command line arguments lakukan logging apabila ada
     * kesalahan dalam sistem hotel pada class panel awal agar dapat
     * ditampilkan.
     */
